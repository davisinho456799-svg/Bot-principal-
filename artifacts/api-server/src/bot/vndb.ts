...
/**
 * Pesquisa visual novels SFW no VNDB (exclui conteúdo adulto explícito).
 * Filtra resultados onde sexual < 2 na imagem.
 */
export async function searchVNDBSFW(query: string): Promise<VNDBResult[]> {
  await throttle();
